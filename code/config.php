...
Config::set("session_iv", "efz6yAXAQwpeSlEy"); // randomly generated in post install script
Config::set("session_key", "5hdyySjbBuvxeLIiHB4DmO3eU3O4qoUR"); // randomly generated in post install script
