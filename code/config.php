...
Config::set("session_iv", "LfONhODHsKnxETiO"); // randomly generated in post install script
Config::set("session_key", "k3lnmgew7yMeas6XOqDBUkUOgcZ6L9NA"); // randomly generated in post install script
